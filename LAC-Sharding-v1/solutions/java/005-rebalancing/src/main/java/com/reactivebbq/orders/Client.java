...
public class Client {
    ...
    private static void printUsageAndExit() {
        ...
        System.out.println("  mvn compile exec:exec -Dexec.args=\"-classpath %classpath com.reactivebbq.orders.Client open <serverName> <tableNumber>\"");
        System.out.println("  mmvn compile exec:exec -Dexec.args=\"-classpath %classpath com.reactivebbq.orders.Client add <orderId> <itemName> <specialInstructions>\"");
        System.out.println("  mvn compile exec:exec -Dexec.args=\"-classpath %classpath com.reactivebbq.orders.Client find <orderId>\"");
